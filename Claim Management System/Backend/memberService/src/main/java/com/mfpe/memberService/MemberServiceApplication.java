...
public class MemberServiceApplication {
	...
	private ApiInfo apiInfo(){
		return new ApiInfo(
				...
				"1.0",
				"Karthika - Programmer Analyst Trainee || Full Stack ...in.linkedin.com",
				new Contact("Karthika", "something.com","karthikavelayutham09@gmail.com"),
				"FSE", "https://hello.karthika.com",
